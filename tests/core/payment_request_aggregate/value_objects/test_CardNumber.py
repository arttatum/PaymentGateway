...
@pytest.mark.parametrize("invalid_card_number", ["a1231231123", "1234567", "12345678912345678912342"])
...
@pytest.mark.parametrize(
    ("card_number", "masked_card_number"), [("123123123", "*****3123"), ("123123123123", "********3123")]
)
